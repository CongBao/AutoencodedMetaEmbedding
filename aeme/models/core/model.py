        ...
        with tf.Session() as self.session:
            ...
            for itr in range(self.epoch):
                ...
                for s1_batch, s2_batch in self._next_batch():
                    ...
                    _, batch_loss = self.session.run([self.optimizer, self.loss], {self.source['cbow']: s1_batch,
                ...
                if itr % 100 == 0:
                    ...
                    result = self.session.run(self.merged_summaries, {self.source['cbow']: cbow_test,
            ...
            for word in self.inter_words:
                ...
                embed_cbow, embed_glove = self.session.run([self.encoder['cbow'], self.decoder['glove']], {self.input['cbow']: i1_cbow,
