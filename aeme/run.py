...
MODEL_NAMES = ['AEModel', 'TiedAEModel', 'ZipAEModel', 'DActivAEModel', 'DeepAEModel', 'AvgAEModel', 'ConcAEModel', 'DActivAvgAEModel', 'ConcModel', 'LinearModel', 'TiedLinearModel', 'SAEModel']
